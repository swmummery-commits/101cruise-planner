...
assert.match(adminBulkJs, /refreshModalContent/);
assert.match(adminBulkJs, /ciBulkClassTableBody/);
assert.doesNotMatch(adminBulkJs, /addEventListener\("input", \(\) => renderModal\(\)\)/);
