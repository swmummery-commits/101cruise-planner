    ...
    <div class="dashboard-route-map dashboard-final-map" aria-label="Illustrative cruise route map from Tokyo to Seoul">
      <svg viewBox="0 0 620 350" role="img" aria-labelledby="dashboardMapTitle dashboardMapDesc">
        ...
        <defs>
          ...
          <path id="dashboardRoutePath" d="M 504.6 138.1 C 498 148 482 160 464.7 154.8 C 445 170 414 208 382 220 C 366 225 354 198 359.3 169.2 C 350 190 326 230 294.5 213.9 C 278 214 258 204 248 194 C 241 187 247 180 256.6 180.8 C 236 198 218 224 208 247 C 200 266 194 281 191.5 287.8 C 177 277 163 257 167.7 243.1 C 170 229 178 216 186.0 210.4 C 169 190 151 169 140.5 151.7 C 113 146 82 128 57 105 C 35 85 38 65 55.8 60.3"/>
        </defs>
        ...
        <g class="dashboard-map-ship" filter="url(#dashboardShipShadow)">
          <circle r="13" fill="#ffffff" stroke="#0c7664" stroke-width="1.7"/>
          <path d="M-9,2 L9,2 L6,7 L-6,7 Z M-6,-1 L6,-1 L4,2 L-4,2 Z M-2,-7 L3,-7 L3,-1 L-2,-1 Z" fill="#0c7664"/>
          <animateMotion dur="24s" repeatCount="indefinite" rotate="0" calcMode="linear"><mpath href="#dashboardRoutePath"/></animateMotion>
        </g>
      </svg>
