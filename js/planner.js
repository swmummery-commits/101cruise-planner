    ...
    <div class="dashboard-route-map dashboard-final-map" aria-label="Illustrative cruise route map from Tokyo to Seoul">
      <svg viewBox="0 0 620 350" role="img" aria-labelledby="dashboardMapTitle dashboardMapDesc">
        ...
        <defs>
          ...
          <path id="dashboardRoutePath" d="M 504.6 138.1 L 482.2 167.2 L 464.7 154.8 L 427.1 206.1 L 378.9 225.6 L 354.8 206.1 L 359.3 169.2 L 341.0 202.2 L 323.8 225.6 L 294.5 213.9 L 268.7 229.4 L 237.7 217.8 L 227.3 194.4 L 256.6 180.8 L 220.4 202.2 L 199.8 241.1 L 186.0 280.0 L 191.5 287.8 L 165.3 299.4 L 144.7 272.2 L 167.7 243.1 L 151.6 221.7 L 165.3 202.2 L 186.0 210.4 L 140.5 151.7 L 110.2 175.0 L 68.9 190.6 L 31.0 167.2 L 17.2 116.7 L 37.9 77.8 L 55.8 60.3"/>
        </defs>
        ...
        <g class="dashboard-map-ship" filter="url(#dashboardShipShadow)">
          <path d="M-13,-5 L8,-5 L14,0 L8,5 L-13,5 L-9,0 Z" fill="#0c5f55" stroke="#fff" stroke-width="1.3"/>
          <rect x="-5" y="-9" width="8" height="4" rx="1" fill="#0c5f55" stroke="#fff" stroke-width="1"/>
          <animateMotion dur="22s" repeatCount="indefinite" rotate="auto" calcMode="linear"><mpath href="#dashboardRoutePath"/></animateMotion>
        </g>
      </svg>
