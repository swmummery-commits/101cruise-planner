...
SET
  ship_naming_style = 'short_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'azamara';

UPDATE public.ci_cruise_lines
SET
  ship_naming_style = 'short_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'celestyal cruises';

UPDATE public.ci_cruise_lines
SET
  ship_naming_style = 'short_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'seabourn cruise line';
...
SET
  ship_naming_style = 'branded_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'avalon waterways';

UPDATE public.ci_cruise_lines
SET
  ship_naming_style = 'branded_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'crystal cruises';

UPDATE public.ci_cruise_lines
SET
  ship_naming_style = 'branded_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'seadream yacht club';
...
SET
  ship_naming_style = 'short_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'royal caribbean international';

UPDATE public.ci_cruise_lines
SET
  ship_naming_style = 'short_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'cunard line';

UPDATE public.ci_cruise_lines
SET
  ship_naming_style = 'short_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'virgin voyages';

UPDATE public.ci_cruise_lines
SET
  ship_naming_style = 'branded_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'silversea cruises';
...
SET
  ship_naming_style = 'short_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'atlas cruises';

UPDATE public.ci_cruise_lines
SET
  ship_naming_style = 'short_vessel',
  updated_at = timezone('utc', now())
WHERE lower(trim(name)) = 'aurora expeditions';
